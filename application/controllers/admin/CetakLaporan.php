...
class CetakLaporan extends CI_Controller{
    ...
    public function index(){
        $data['title'] = 'Filter Laporan Faktur';
        $this->load->view('templates_admin/header', $data);
        $this->load->view('templates_admin/sidebar');
        $this->load->view('admin/filterLaporanFaktur', $data);
        $this->load->view('templates_admin/footer');
    }

    public function cetakLaporanFaktur(){
        $data['title'] = 'Cetak Laporan Faktur';
        ...
        $this->load->view('templates_admin/header', $data);
        $this->load->view('admin/cetakLaporanFaktur', $data);
    }
